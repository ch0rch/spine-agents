...
- `legal.md` — Agente genérico del área de Legal

## Cómo agregar agentes especializados

Si el área de Legal necesita agentes más específicos, podés crearlos siguiendo la guía en `_meta/HOW-TO-ADD-AGENT.md`.
...
Sos el especialista en [tema específico] del área de Legal.
